...
设计模式需要学习哪些知识点？这是一个很好的问题，因为设计模式是一种提高软件开发质量和效率的重要方法。根据我搜索的结果，如果你想系统地学习设计模式，你需要掌握以下几方面的知识：

- [**设计模式的分类**，你需要了解设计模式有哪些种类，以及它们的特点和适用场景。一般来说，设计模式分为三大类：创建型模式、结构型模式和行为型模式，每一类又包含了多种具体的模式，如工厂方法、单例、适配器、观察者等](https://www.runoob.com/design-pattern/design-pattern-tutorial.html)[1](https://www.runoob.com/design-pattern/design-pattern-tutorial.html)。
- [**设计模式的六大原则**，你需要了解设计模式的基本思想和目标，以及它们遵循的一些原则和规范。这些原则包括：开闭原则、里氏替换原则、依赖倒转原则、接口隔离原则、迪米特法则和合成复用原则](https://www.liaoxuefeng.com/wiki/1252599548343744/1264742167474528)[2](https://www.liaoxuefeng.com/wiki/1252599548343744/1264742167474528)。
- [**设计模式的实现和应用**，你需要了解设计模式的具体实现方式和代码示例，以及它们在实际项目中的应用和效果。你可以通过阅读一些优秀的书籍和教程，或者参考一些开源的项目和框架，来学习设计模式的实现和应用](https://zhuanlan.zhihu.com/p/128145128)[3](https://bing.com/search?q=设计模式)[4](https://zhuanlan.zhihu.com/p/128145128)[5](https://zhuanlan.zhihu.com/p/93770973)。
- [**设计模式的评价和改进**，你需要了解设计模式的优缺点和局限性，以及它们在不同的场景和需求下的适用性和变化性。你可以通过分析一些案例和问题，或者参与一些讨论和交流，来学习设计模式的评价和改进](https://zhuanlan.zhihu.com/p/435927070)[6](https://zhuanlan.zhihu.com/p/435927070)[7](https://www.zhihu.com/question/382932535)。
...
* https://zhuanlan.zhihu.com/p/187496375
* https://zhuanlan.zhihu.com/p/351378416
* Python观察者模式：https://blog.csdn.net/submarineas/article/details/109348760
* 桥接模式：https://mp.weixin.qq.com/s?__biz=MzI2OTQ1NzEyMQ==&mid=2247484018&idx=1&sn=aa2f3e75058eb7df8ad0c640633c6afd&chksm=eae141fcdd96c8eaf01e69b8df0eaeb5e00cfaf8433976dfa7545c1e4fed71b76fb02983978e&scene=21#wechat_redirect
* 设计模式：https://zhuanlan.zhihu.com/p/57869247
* 组合模式：https://mp.weixin.qq.com/s?__biz=MzI2OTQ1NzEyMQ==&mid=2247484023&idx=1&sn=c7b59f06f881a53369fea6811547661e&chksm=eae141f9dd96c8efb6b3dffd19df51ecd64e745d234f8f020613664a661afb24721fa8e72fc1&scene=21#wechat_redirect
